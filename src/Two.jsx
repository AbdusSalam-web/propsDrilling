    ...
    <>
      <div>
        ...
        <button
          ...
          className=" border-[1px] border-[transparent] rounded-[8px] py-[.6em] px-[1.2em] text-[1em] font-medium font-sans bg-[#1a1a1a] pointer text-white  disabled:bg-[#b4b4b4] disabled:cursor-not-allowed transition-all duration-500 hover:bg-teal-500 "
        >
          + Add
        </button>
